...
| 2026-08-08 | implementado | Cerrado. Todos los criterios en `[x]` y revisión de código aplicada. **Se commiteó directo a `main`, sin rama ni PR** — contra la regla 26; queda dicho para que el próximo spec no lo tome de precedente. |
