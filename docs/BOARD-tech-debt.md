...
- [ ] [[tech-debt/0016-los-formularios-de-cuadrillas-no-usan-la-rejilla|DEBT-0016: Los formularios de Cuadrillas maquetan cada uno a su manera y no usan la rejilla del panel]] — **severidad baja**: es deuda de cronología y no de criterio. SPEC-0010 estrenó `styles/_form.scss` y pasó por ella a Clientes y Obras; SPEC-0011 entró después, escrito antes de que ese archivo existiera, así que sus cinco diálogos resuelven la maqueta por su cuenta. Nada se ve roto —todos consumen tokens, cero hex literales, verificados en los dos temas—: lo que falta es reemplazar maqueta propia por los mixins que ya existen, y **tres de las cinco lo necesitan**, que los de dos campos apilados están bien así. Deja también por confirmar `crew-colors.ts`, hoy fuera de los tokens por ser dato de dominio y no color de tema
